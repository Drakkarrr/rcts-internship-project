exports.SendInvoice = ({ title = 'Invoice from rcts', name = '', time = new Date() }) => {
  return `
    <div>
...
exports.SendQuote = ({ title = 'Quote from rcts', name = '', time = new Date() }) => {
  return `
    <div>
...
exports.SendOffer = ({ title = 'Offer from rcts', name = '', time = new Date() }) => {
  return `
    <div>
